        ...
        <div className="w-full h-full flex flex-col items-center justify-center relative overflow-hidden bg-[#050505]">
            ...
            <AnimatePresence mode="wait">
                ...
                {step === 84 && (
                    ...
                    >
                        <motion.div
                            className="w-40 h-40 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center shadow-2xl"
                        ...
                        <div>
                            <h1 className="text-5xl font-black text-white">Yann LeCun</h1>
                            <p className="text-xl text-gray-400 mt-2">on this stuff...</p>
                        </div>
                    </motion.div>
                )}
                ...
                {step === 90 && (
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                    >
                        <p className="text-2xl text-gray-400 mb-6">LLMs can...</p>
                ...
                {(step === 91 || step === 92) && (
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                    >
                        <p className="text-2xl text-gray-400 mb-8">But we still don't have...</p>
                        ...
                        <div className="flex gap-12">
                            {step === 91 && (
                                ...
                                >
                                    ...
                                    <span className="text-red-400 mt-4">❌ Domestic Robots</span>
                                </motion.div>
                            )}
                            ...
                            {step === 92 && (
                                ...
                                >
                                    ...
                                    <span className="text-red-400 mt-4">❌ Level 5 Self-Driving</span>
                                    <span className="text-gray-500 text-sm mt-1">"We have them, but we cheat"</span>
                                </motion.div>
                            )}
                        </div>
                    </motion.div>
