...
const CCTVComparisonScene = ({ step }) => {
    return (
            ...
            <AnimatePresence mode="wait">
                ...
                {step === 37 && (
                    ...
                    >
                        ...
                        <h2 className="text-3xl font-bold text-gray-400">Looks at each frame</h2>
                        <p className="text-xl text-orange-400 mt-2">Guesses → Spits out text immediately</p>
                    </motion.div>
                )}
                ...
                {(step === 42 || step === 43) && (
                    ...
                    >
                        ...
                        {step === 42 && (
                            <p className="text-2xl text-gray-400">Video stream + Something else...</p>
                        )}
                        ...
                        {step === 43 && (
                            ...
                            >
                                ...
                                <p className="text-xl text-gray-500 mt-2">Building a stable understanding</p>
                            </motion.div>
                        )}
                    </motion.div>
                )}
                ...
                {step === 45 && (
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-red-400 font-bold mt-4">Red Dot</span>
                            <span className="text-gray-500">"Maybe bottle?"</span>
                        </motion.div>
                ...
                {step === 46 && (
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-blue-400 font-bold mt-4">Blue Dot</span>
                            <span className="text-green-400">"It's a canister"</span>
                        </motion.div>
