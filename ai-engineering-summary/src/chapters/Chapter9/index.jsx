    ...
    <div className="flex items-center justify-center gap-20 h-full">
        ...
        >
            <div className="flex items-center gap-6">
                <div className="w-40 h-40 bg-gradient-to-br from-blue-400 to-blue-500 rounded-2xl flex flex-col items-center justify-center text-white shadow-xl">
                    <div className="text-7xl">📂</div>
                    <div className="mt-2 font-bold">External</div>
                    <div className="text-lg">Memory</div>
                </div>
                <div className="text-7xl">+</div>
                <div className="w-40 h-40 bg-gradient-to-br from-green-400 to-green-500 rounded-2xl flex flex-col items-center justify-center text-white shadow-xl">
                    <div className="text-7xl">🧠</div>
                    <div className="mt-2 font-bold">LLM</div>
                    <div className="text-lg">Generation</div>
                </div>
            </div>
            <motion.div
