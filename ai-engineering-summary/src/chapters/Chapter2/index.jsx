...
export const Scene5 = () => (
    <div className="flex flex-col items-center justify-center gap-6 h-full">
        ...
        <motion.div
            className="w-[400px] h-36 bg-gradient-to-br from-yellow-100 to-amber-100 border-4 border-yellow-500 rounded-2xl flex items-center justify-center shadow-xl relative z-20"
            initial={{ y: -200, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 3.0, type: "spring", damping: 12 }} // Drop from above
        >
            <div className="absolute -left-36 top-1/2 transform -translate-y-1/2">
                <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 3.5 }}>
