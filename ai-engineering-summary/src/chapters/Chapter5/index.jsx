...
export const Scene1 = () => (
    <div className="flex flex-col items-center justify-center gap-12 h-full">
        <motion.h1
            className="text-9xl font-black text-zinc-800 uppercase tracking-tighter"
        ...
        <motion.div
            className="bg-gradient-to-r from-indigo-100 to-purple-100 border-4 border-indigo-500 px-10 py-4 rounded-full text-5xl font-hand font-bold text-indigo-800"
