...
// Scene 4: ANSWER REVEAL - The Tuple Gotcha
const Scene4 = ({ speed = 1 }) => {
    return (
        <div className="w-full h-full flex flex-col items-center justify-center gap-10 p-12 relative">
            ...
            {/* Answer Box */}
            <motion.div
                className="code-block w-full max-w-xl text-4xl text-center"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
            ...
            >
                <p className="text-2xl text-text-dark">
                    Tuples are <span className="text-accent font-bold">immutable</span>... but
                    <span className="text-primary font-bold"> mutable elements inside</span> can still change!
                </p>
            </motion.div>
