...
import DecoratorScene1 from './scenes/DecoratorScene1';
import DecoratorScene2 from './scenes/DecoratorScene2';
import DecoratorScene3 from './scenes/DecoratorScene3';
import DecoratorScene4 from './scenes/DecoratorScene4';
import DecoratorScene5 from './scenes/DecoratorScene5';
import DecoratorScene6 from './scenes/DecoratorScene6';
import DebugPanel from './components/DebugPanel';

const SCENES = [DecoratorScene1, DecoratorScene2, DecoratorScene3, DecoratorScene4, DecoratorScene5, DecoratorScene6];

// Audio files for each scene
const AUDIO_FILES = [
    '/audio/decorator1_hook.mp3',
    '/audio/decorator2_principle.mp3',
    '/audio/decorator3_wrapper.mp3',
    '/audio/decorator4_syntax.mp3',
    '/audio/decorator5_reveal.mp3',
    '/audio/decorator6_outro.mp3'
];

// Fallback durations (seconds * 1000)
const SCENE_DURATIONS = [
    9000, 6000, 7000, 6000, 7000, 4000
];
